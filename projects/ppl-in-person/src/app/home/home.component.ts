...
export class HomeComponent implements OnInit {
  ...
  get isLeaderAndHasValidIdToken() {
     return this.hasValidIdToken && this.isLeader;
  }

  get isChallengerAndHasValidIdToken() {
    return this.hasValidIdToken && this.isChallenger;
  }
